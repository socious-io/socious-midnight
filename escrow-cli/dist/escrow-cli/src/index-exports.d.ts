 ...
 * ```
 */
export { EscrowContractAPI, createEscrowAPI, hexToBytes32, hexToPublicKey, createCoinInfo, TESTNET_CONFIG, TESTNET_CONTRACT_ADDRESS, type EscrowProviders, type CreateEscrowParams, type NetworkConfig, type EscrowPrivateState } from './browser-api';
