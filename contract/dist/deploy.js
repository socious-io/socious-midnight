...
export async function deployEscrow() {
    ...
    logger.info("Note: This contract should be deployed using the escrow-cli deployment pattern.");
    logger.info("See /escrow-cli/src/index.ts for the full deployment implementation.");
    return escrow;
}
